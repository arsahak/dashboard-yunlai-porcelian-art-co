  ...
  return (
    <div className={`min-h-screen p-6 ${isDark ? "bg-gray-900" : "bg-gray-50"}`}>
      ...
      <div className="mb-6 animate-pulse">
        <div className={`h-8 w-56 rounded mb-2 ${isDark ? "bg-gray-800" : "bg-gray-200"}`}></div>
        <div className={`h-4 w-96 rounded ${isDark ? "bg-gray-800" : "bg-gray-200"}`}></div>
      </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <div className={`h-4 w-24 rounded mb-2 ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
      ...
      >
        ...
        <div className={`px-6 py-3 ${isDark ? "bg-gray-700" : "bg-gray-50"}`}>
          <div className="flex gap-4 animate-pulse">
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className={`h-4 rounded ${i === 1 ? "w-32" : "w-24"} ${
          ...
          {[1, 2, 3, 4, 5].map((row) => (
            ...
            >
              <div className="flex items-center gap-4 animate-pulse">
                <div className={`w-12 h-12 rounded ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
                <div className="flex-1 flex gap-4">
                  <div className={`h-4 w-32 rounded ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
                  <div className={`h-4 w-16 rounded ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
                  <div className={`h-4 w-20 rounded ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
                  <div className={`h-4 w-20 rounded ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
                </div>
              </div>
            </div>
        ...
        >
          <div className={`h-4 w-48 rounded ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
          <div className="flex gap-2">
            <div className={`h-10 w-24 rounded-lg ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
            <div className={`h-10 w-24 rounded-lg ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
          </div>
        </div>
      </div>
