  ...
  return (
    <div className={`min-h-screen p-6 ${isDark ? "bg-gray-900" : "bg-gray-50"}`}>
      ...
      <div className="mb-6 animate-pulse">
        <div className={`h-8 w-48 rounded mb-2 ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
        <div className={`h-4 w-64 rounded ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
      </div>
        ...
        <div className={`px-6 py-3 ${isDark ? "bg-gray-700" : "bg-gray-50"}`}>
          <div className="flex gap-4 animate-pulse">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div
                key={i}
                className={`h-4 rounded ${i === 1 ? "w-32" : i === 6 ? "w-20" : "w-24"} ${
