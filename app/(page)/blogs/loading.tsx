          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <div className={`h-4 w-20 rounded mb-2 ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
                <div className={`h-8 w-12 rounded ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
              </div>
        ...
        <div className={`px-6 py-3 ${isDark ? "bg-gray-700" : "bg-gray-50"}`}>
          <div className="flex gap-4 animate-pulse">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div
                key={i}
                className={`h-4 rounded ${i === 1 ? "w-40" : "w-24"} ${
          ...
          {[1, 2, 3, 4, 5].map((row) => (
            ...
            >
              <div className="flex items-center gap-4 animate-pulse">
                <div className={`w-10 h-10 rounded ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
                <div className="flex-1 flex gap-4">
                  <div className={`h-4 w-36 rounded ${isDark ? "bg-gray-700" : "bg-gray-200"}`}></div>
